    ...
    <section id="slide" class="slider-section">
        <div id="slider-item" class="slider-item-details">
            <div class="slider-area slider-bg-1 relative-position"
                style="background-image: url({{ asset('front/img/banner/sd-1nice.jpg') }});">
        ...
        <div class="jarallax">
            <div class="container">
                ...
                <div class="teacher-list">
                    ...
                    <div class="genius-btn gradient-bg text-center text-uppercase ul-li-block bold-font ">
                        <a href="#">Lihat Semua Guru <i class="fas fa-caret-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="app-mock-up">
                            <img src="https://jthemes.net/themes/html/genius-course/assets/img/about/ab-2.png" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="about-us-text search-app-content">
                            ...
                            <div class="app-details-content">
                                <p>
                                    Kami perkenalkan aplikasi MAN 1 Padang Panjang yang dapat membantu siswa, guru, dan orang tua dalam memperoleh informasi terkait kegiatan sekolah, nilai, dan lainnya.
