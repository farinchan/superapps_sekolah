                    ...
                    <div class="blog-details-content">
                        <div class="post-content-details">
                            ...
                            <div class="date-meta text-uppercase">
                                ...
                                <span><i class="fas fa-user"></i> <a
                                        href="{{ route('staff.detail', $news->user?->teacher?->id) }}">{{ $news->user?->teacher?->name }}</a>
                                </span>
                        ...
                        <div class="blog-share-tag">
                            ...
                            <div class="share-social ul-li float-right">
                                <ul>
                                    <li><a href="https://www.facebook.com/sharer/sharer.php?u={{ route('news.show', $news->slug) }}&t={{ $news->title }}"
                                            target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="https://twitter.com/intent/tweet?url={{ route('news.show', $news->slug) }}&text={{ $news->title }}"
                                            target="_blank"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="https://www.linkedin.com/shareArticle?mini=true&url={{ route('news.show', $news->slug) }}&title={{ $news->title }}"
                                            target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                    <li><a href="https://wa.me/?text={{ route('news.show', $news->slug) }}&title={{ $news->title }}"
                        ...
                        <div class="next-prev-post">
                            @if ($prev_news)
                                <div class="next-post-item float-left">
                                    <a href="{{ route('news.show', $prev_news->slug) }}"><i
                                            class="fas fa-arrow-circle-left"></i>Berita Sebelumnya</a>
                                </div>
                            @endif

                            @if ($next_news)
                                <div class="next-post-item float-right">
                                    <a href="{{ route('news.show', $next_news->slug) }}">Berita Selanjutnya<i
                    ...
                    <div class="blog-comment-area ul-li about-teacher-2">
                        ...
                        <div class="reply-comment-box">
                            ...
                            <div class="teacher-faq-form">
                                <form method="POST" action="{{ route('news.comment', $news->slug) }}"
