...
@include('exam/layout/partials/header/_menu/__pages-general')
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
        <div class="tab-pane  w-lg-600px" id="kt_app_header_menu_pages_account">
@include('exam/layout/partials/header/_menu/__pages-account')
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
        <div class="tab-pane  w-lg-1000px" id="kt_app_header_menu_pages_authentication">
@include('exam/layout/partials/header/_menu/__pages-authentication')
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
        <div class="tab-pane  w-lg-1000px" id="kt_app_header_menu_pages_utilities">
@include('exam/layout/partials/header/_menu/__pages-utilities')
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
        <div class="tab-pane  w-lg-500px" id="kt_app_header_menu_pages_widgets">
@include('exam/layout/partials/header/_menu/__pages-widgets')
        </div>
        <!--end:Tab pane-->
    </div>
    <!--end:Tab content-->
