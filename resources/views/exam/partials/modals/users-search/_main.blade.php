        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div
                    ...
                    <!--begin::Wrapper-->
                    <div class="py-5">
@include('exam/partials/modals/users-search/partials/_suggestions')
@include('exam/partials/modals/users-search/partials/_results')
@include('exam/partials/modals/users-search/partials/_empty')
                    </div>
                    <!--end::Wrapper-->
                </div>
                <!--end::Search-->
