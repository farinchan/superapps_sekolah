                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @foreach ($list_exam as $exam)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('back.ppdb.exam.setting', $exam->id) }}"
    ...
    <div class="modal fade" tabindex="-1" id="add_exam">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('back.ppdb.exam.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="name" class="form-label required">Nama Ujian</label>
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nama Ujian" required>
                        </div>
                        <div class="mb-3">
