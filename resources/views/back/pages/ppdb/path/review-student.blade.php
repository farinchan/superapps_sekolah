                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column me-5 mb-3 mb-md-0 fs-6 min-w-lg-200px">
                                <li class="nav-item w-100 me-0 mb-md-2">
                                    <a class="nav-link w-100 active btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab1">
                                ...
                                <li class="nav-item w-100 me-0 mb-md-2">
                                    <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab2">
                                        <span class="svg-icon fs-2"><svg>...</svg></span>
                                        <span class="d-flex flex-column align-items-start">
                                ...
                                <li class="nav-item w-100">
                                    <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab3">
                                        <span class="svg-icon fs-2"><svg>...</svg></span>
                                        <span class="d-flex flex-column align-items-start">
                                ...
                                <li class="nav-item w-100">
                                    <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab4">
                                        <span class="svg-icon fs-2"><svg>...</svg></span>
                                        <span class="d-flex flex-column align-items-start">
                    ...
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="fv-row">
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Nomor Induk Siswa Nasional" name="nisn" value="{{ $registration_user->user?->nisn }}"
                                                required readonly />
                                            @error('nisn')
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="Nama Lengkap"
                                                name="name" value="{{ $registration_user->user?->name }}" required readonly />
                                            @error('name')
                                                <small class="text-danger">*{{ $message }}</small>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control form-control-solid"
                                                        ...
                                                        value="{{ $registration_user->user?->birth_place }}" required readonly />
                                                    @error('birth_place')
                                                        <small class="text-danger">*{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control form-control-solid"
                                                        ...
                                                        value="{{ $registration_user->user?->birth_date }}" required readonly />
                                                    @error('birth_date')
                                                        <small class="text-danger">*{{ $message }}</small>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="+628XXXXX"
                                                name="whatsapp_number" value="{{ $registration_user->user?->whatsapp_number }}" required readonly />
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="email" class="form-control form-control-solid" placeholder="Email"
                                                name="email" value="{{ $registration_user->user?->email }}" readonly />
                                            @error('email')
                                                <small class="text-danger">*{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="fv-row">
                                        <div class="mb-5">
                                            <label for="exampleFormControlInput1" class="required form-label">No Kartu
                                                Keluarga</label>
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Nomor Kartu Keluarga" name="no_kk" value="{{ $registration_user->user?->no_kk }}"
                                                required readonly />
                                            @error('no_kk')
                                                <small class="text-danger">*{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Nomor Induk Kependudukan" name="nik" value="{{ $registration_user->user?->nik }}"
                                                required readonly />
                                            @error('nik')
                                                <small class="text-danger">*{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Nama Lengkap" name="mother_name" value="{{ $registration_user->user?->mother_name }}"
                                                required readonly />
                                            @error('mother_name')
                                                <small class="text-danger">*{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="mb-5">
                                            <label for="exampleFormControlInput1" class="required form-label">No WhatsApp
                                                Ibu</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="+628XXXXX"
                                                name="mother_phone_number" value="{{ $registration_user->user?->mother_phone_number }}" required readonly />
                                            <small class="text-muted">Nomor diawali dengan kode negara <code> +62 </code> Pastikan
                                                nomor yang anda masukkan benar dan aktif.</small>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Nama Lengkap" name="father_name" value="{{ $registration_user->user?->father_name }}"
                                                required readonly />
                                            @error('father_name')
                                                <small class="text-danger">*{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="mb-5">
                                            <label for="exampleFormControlInput1" class="required form-label">No WhatsApp
                                                Ayah</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="+628XXXXX"
                                                name="father_phone_number" value="{{ $registration_user->user?->father_phone_number }}" required readonly />
                                            <small class="text-muted">Nomor diawali dengan kode negara <code> +62 </code> Pastikan
                                                nomor yang anda masukkan benar dan aktif.</small>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-10">
                                            <label for="exampleFormControlInput1"
                                                ...
                                                <!--begin::Overlay-->
                                            <a class="d-block overlay" data-fslightbox="lightbox-basic" href="{{ asset('storage/' . $registration_user->user?->screenshoot_nisn) }}">
                                                <!--begin::Image-->
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    id="flexCheckDefault"
                                                    @if (in_array('Brosur dan Pamflet sekolah', $registration_user->user?->additional_data?? [] )) checked @endif
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    @if (in_array('Sosmed (IG, FB, Yt, WA Group, Tiktok)', $registration_user->user?->additional_data?? [])) checked @endif
                                                    onclick="return false" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    id="flexCheckDefault"
                                                    @if (in_array('Siswa/Siswi MAN 1 Padang Panjang', $registration_user->user?->additional_data?? [])) checked @endif
                                                    onclick="return false" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    name="additional_data[]" id="flexCheckDefault"
                                                    @if (in_array('Website MAN 1 Padang Padang Panjang', $registration_user->user?->additional_data?? [])) checked @endif
                                                    onclick="return false" />
                                                <label class="form-check-label" for="flexCheckDefault">
                                            ...
                                            @php
                                                $additional_data_array = (array) $registration_user->user?->additional_data?? [];
                        ...
                        <div class="tab-pane fade" id="tab4" role="tabpanel">
                            <div class="card shadow-sm">
                                ...
                                <form action="{{ route('back.ppdb.path.review-student.update', [$path_id, $registration_id]) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <div class="m-5">
                                                ...
                                                <select class="form-select form-select-solid" name="status_kelulusan" id="status_kelulusan" required >
                                                    ...
                                                    <option value="LULUS MADRASAH DAN DITERIMA DI ASRAMA" @if ($registration_user->status_kelulusan == 'LULUS MADRASAH DAN DITERIMA DI ASRAMA') selected @endif>LULUS MADRASAH DAN DITERIMA DI ASRAMA</option>
                                                    <option value="LULUS MADRASAH DAN TIDAK DITERIMA DI ASRAMA" @if ($registration_user->status_kelulusan == 'LULUS MADRASAH DAN TIDAK DITERIMA DI ASRAMA') selected @endif>LULUS MADRASAH DAN TIDAK DITERIMA DI ASRAMA</option>
                                                    <option value="LULUS PRESTASI MADRASAH DAN DITERIMA DI ASRAMA" @if ($registration_user->status_kelulusan == 'LULUS PRESTASI MADRASAH DAN DITERIMA DI ASRAMA') selected @endif>LULUS PRESTASI MADRASAH DAN DITERIMA DI ASRAMA</option>
                                                    <option value="LULUS PRESTASI MADRASAH DAN TIDAK DITERIMA DI ASRAMA" @if ($registration_user->status_kelulusan == 'LULUS PRESTASI MADRASAH DAN TIDAK DITERIMA DI ASRAMA') selected @endif>LULUS PRESTASI MADRASAH DAN TIDAK DITERIMA DI ASRAMA</option>
                                                    ...
                                                    <option value="LULUS/ DITERIMA ASRAMA" @if ($registration_user->status_kelulusan == 'LULUS/ DITERIMA ASRAMA') selected @endif disabled >LULUS/ DITERIMA ASRAMA</option>
                                                    <option value="LULUS/ TIDAK DIASRAMA" @if ($registration_user->status_kelulusan == 'LULUS/ TIDAK DIASRAMA') selected @endif disabled>LULUS/ TIDAK DIASRAMA</option>
                                                    <option value="LULUS PRESTASI/ASRAMA" @if ($registration_user->status_kelulusan == 'LULUS PRESTASI/ASRAMA') selected @endif disabled>LULUS PRESTASI/ASRAMA</option>
                                                    <option value="LULUS PRESTASI/TIDAK DIASRAMA" @if ($registration_user->status_kelulusan == 'LULUS PRESTASI/TIDAK DIASRAMA') selected @endif disabled>LULUS PRESTASI/TIDAK DIASRAMA</option>
                                                </select>
                                            ...
                                            <div class="m-5">
                                                <label for="exampleFormControlInput1" class="required form-label">Tangapan</label>
                                                ...
                                                <small class="text-muted">Tangapan yang diberikan kepada calon siswa</small>
                                                @error('reason')
                                                    <small class="text-danger">*{{ $message }}</small>
                                                @enderror
                                            </div>
