                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            {{-- <a href="{{ route('back.user.student.create') }}" class="btn btn-primary me-3">
                            ...
                            <div class="btn-group">
                                ...
                                {{-- <a href="#" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#import">
                                    ...
                                    Import</a> --}}
                                <a class="btn btn-secondary" href="{{ route('back.ppdb.student.export') }}">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        <thead>
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Ayah</th>
                                <th class="min-w-125px">Ibu</th>
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <ul>
                                                <li><span class="fw-bold">WA: </span>{{ $user->whatsapp_number }}</li>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <ul>
                                                <li><span class="fw-bold">Nama: </span>{{ $user->mother_name }}</li>
                                                <li><span class="fw-bold">NIK:</span>{{ $user->mother_nik }}</li>
                                                <li><span class="fw-bold">WA:</span>{{ $user->mother_phone_number }}</li>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <ul>
                                                <li><span class="fw-bold">Nama: </span>{{ $user->father_name }}</li>
                                                <li><span class="fw-bold">NIK:</span>{{ $user->father_nik }}</li>
                                                <li><span class="fw-bold">WA:</span>{{ $user->father_phone_number }}</li>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('back.ppdb.student.detail', $user->id) }}"
    ...
    {{-- <div class="modal fade" tabindex="-1" id="import">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="form" method="POST" action="{{ route('back.user.student.import') }}"
