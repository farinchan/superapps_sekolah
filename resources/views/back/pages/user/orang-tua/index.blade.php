...
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-user-table-filter="search"
                                class="form-control form-control-solid w-250px ps-13" placeholder="Cari Orang Tua" />
                        </div>
                    </div>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    <div class="mb-5">
                                        ...
                                        <select class="form-select form-select-solid fw-bold" data-kt-select2="true"
                                            ...
                                            data-kt-user-table-filter="orangtua" data-hide-search="true">
                                            <option></option>
                            ...
                            <a href="{{ route('back.user.parent.create') }}" class="btn btn-primary me-3">
                                <i class="ki-duotone ki-plus fs-2"></i>Tambah Orang Tua</a>
                            <div class="btn-group">
                                ...
                                <a href="#" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#import">
                                    ...
                                    Import</a>
                                <a class="btn btn-secondary" href="{{ route('back.user.parent.export') }}">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="#">
                                                <div class="symbol-label">
                                                    <img src="{{ $user->student?->getPhoto() }}"
                                                        alt="{{ $user->student?->name }}" width="50px" />
                                                </div>
                                            </a>
                                        </div>
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $user->student?->name }}</a>
                                            <span> NISN.{{ $user->student?->nisn }}</span>
                                            <span> NIK.{{ $user->student?->nik }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('back.user.parent.edit', $user->id) }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body px-5">
                        <form class="form" method="POST"
                            action="{{ route('back.user.parent.destroy', $user->id) }}">
                            @method('DELETE')
                            @csrf
                            <h3 class="text-center">
                                Apakah Anda Yakin Ingin Menghapus Orang Tua {{ $user->name }} ?
                            </h3>
    ...
    <div class="modal fade" tabindex="-1" id="import">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Import Orang Tua</h3>
                ...
                <form class="form" method="POST" action="{{ route('back.user.parent.import') }}"
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <small>File Excel Harus Sesuai Dengan Format Yang Telah Disediakan <br>
                                <a href="{{ asset('file_ext/parent_import_template.xlsx') }}" class="text-primary">Download Format
                                    Excel</a>
                            </small>
