                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-5">
                                                <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                                    data-kt-ecommerce-category-filter="category_name">{{ $student_achievement->event }}</a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex justify-content-start flex-column">
                                                ...
                                                <span
                                                    class="text-muted fw-bold">{{ $student_achievement->date->format('d M Y')}}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('back.achievement.student.destroy', $student_achievement->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <p>Apakah Anda yakin ingin menghapus prestasi <strong>{{ $student_achievement->title }}</strong>?</p>
                            </div>
                        </div>
