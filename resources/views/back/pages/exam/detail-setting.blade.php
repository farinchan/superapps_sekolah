                    ...
                    <div class="card-body p-9">
                        <div class="row mb-8">
                            ...
                            <div class="col-xl-9 fv-row">
                                ...
                                data-placeholder="Select an option" @notRole('admin') disabled @endrole >
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-xl-9 fv-row">
                                <input class="form-control form-control-solid form-control-lg" name="start_time" type="datetime-local"
                                    value="{{ $exam->start_time }}" @notRole('admin') disabled @endrole/>
                            </div>
                        </div>
                        <div class="row mb-8">
                            <div class="col-xl-3">
                            ...
                            <div class="col-xl-9 fv-row">
                                <input class="form-control form-control-solid form-control-lg" name="end_time" type="datetime-local"
                                    value="{{ $exam->end_time }}" @notRole('admin') disabled @endrole/>
                            </div>
                        </div>
                        <div class="row mb-8">
                            <div class="col-xl-3">
                            ...
                            <div class="col-xl-9 fv-row">
                                <input class="form-control form-control-solid form-control-lg" name="duration"
                                    value="{{ $exam->duration }}" @notRole('admin') disabled @endrole/>
                            </div>
                        </div>
                        <div class="row mb-8">
                            <div class="col-xl-3">
