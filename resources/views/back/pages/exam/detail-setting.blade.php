                    ...
                    <div class="card-body p-9">
                        <div class="row mb-8">
                            ...
                            <div class="col-xl-9 fv-row">
                                ...
                                data-placeholder="Select an option" @role('admin|proktor')  @else disabled @endrole >
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-xl-9 fv-row">
                                <textarea class="form-control form-control-solid form-control-lg" name="description"
                                    rows="3" @role('admin|proktor')  @else disabled @endrole>{{ $exam->description }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-8">
                            <div class="col-xl-3">
                            ...
                            <div class="col-xl-9 fv-row">
                                <input class="form-control form-control-solid form-control-lg" name="start_time" type="datetime-local"
                                    value="{{ $exam->start_time }}" @role('admin|proktor')  @else disabled @endrole/>
                            </div>
                        </div>
                        <div class="row mb-8">
                            <div class="col-xl-3">
                            ...
                            <div class="col-xl-9 fv-row">
                                <input class="form-control form-control-solid form-control-lg" name="end_time" type="datetime-local"
                                    value="{{ $exam->end_time }}" @role('admin|proktor')  @else disabled @endrole/>
                            </div>
                        </div>
                        <div class="row mb-8">
                            <div class="col-xl-3">
                            ...
                            <div class="col-xl-9 fv-row">
                                <input class="form-control form-control-solid form-control-lg" name="duration"
                                    value="{{ $exam->duration }}" @role('admin|proktor')  @else disabled @endrole/>
                            </div>
                        </div>
                        <div class="row mb-8">
                            <div class="col-xl-3">
                        ...
                        <div class="row mb-8">
                            <div class="col-xl-3">
                                <div class="fs-6 fw-semibold mt-2 mb-3">Semeseter</div>
                            </div>
                            <div class="col-xl-9 fv-row">
                                <select class="form-select form-select-solid form-select-lg fw-bold" name="semester" data-control="select2" data-hide-search="true"
                                data-placeholder="Select an option" @role('admin|proktor')  @else disabled @endrole>
                                    <option value="ganjil" @if ($exam->semester == 'ganjil') selected @endif>Semester Ganjil</option>
                                    <option value="genap" @if ($exam->semester == 'genap') selected @endif>Semester Genap</option>
                                </select>
                            </div>
                        </div>
