        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Buat Soal - PIlihan Ganda Kompleks</h3>
                </div>
                <form action="{{ route("back.exam.question.multiple-choice-complex.store", $exam_id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="mb-5">
                                                ...
                                                <div class="col-md-2">
                                                    <div
                                                        ...
                                                        <input class="form-check-input" type="checkbox" name="is_correct"
                                                            class="is_correct" value="1" id="form_checkbox" />
