...
@section('content')
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        <thead>
                            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-2500px">Deskripsi</th>
    ...
    <div class="modal fade" tabindex="-1" id="add">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('back.subject.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="title" name="description" placeholder="Deskripsi"
                                required></textarea>
                        </div>
                    </div>
    ...
    <div class="modal fade" tabindex="-1" id="edit{{ $item->id }}">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Edit Mata Pelajaran</h3>
                ...
                <form action="{{ route('back.subject.update', $item->id ) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
        ...
        <div class="modal fade" tabindex="-1" id="delete{{ $item->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('back.subject.destroy', $item->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
                                <p>Apakah Anda yakin ingin menghapus mata pelajaran <strong> {{ $item->name }} </strong> ?</p>
                            </div>
                        </div>
