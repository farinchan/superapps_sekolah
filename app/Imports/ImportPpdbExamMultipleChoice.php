...
class ImportPpdbExamMultipleChoice implements ToModel, WithHeadingRow, WithValidation, WithStartRow
{
    /**
    ...
    public function model(array $row)
    {
        ...
        if ($row[1] == "Q") {
            $question = new PpdbExamQuestion();
            $question->ppdb_exam_id = $this->exam_id;
            ...
            $multipleChoice = new PpdbExamQuestionMultipleChoice();
            $multipleChoice->ppdb_exam_question_id = $this->question_id;
